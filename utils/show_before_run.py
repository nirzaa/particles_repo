...
en_dep = EcalDataIO.ecalmatio(os.path.join('./data', 'raw', 'signal.al.elaser.IP03.edeplist.mat'))  # Dict with 100000 samples {(Z,X,Y):energy_stamp}
energies = EcalDataIO.energymatio(os.path.join('./data', 'raw', 'signal.al.elaser.IP03.energy.mat'))
