...
def merge_and_split_data(path, relation, moment, min_shower_num, max_shower_num, file):
    ...
    for i in file:
        ...
        edep_file = os.path.join('./', 'data', 'raw', f'4p0-edeplist.mat')
        edep_file_noise = os.path.join('./', 'data', 'raw', '4p0-edeplist.mat')
        en_file = os.path.join('./', 'data', 'raw', f'4p0-energy.mat')
